...
target_assigner = dict(
    ...
    anchor_generators=[
        dict(
            ...
            anchor_ranges = [0, -25.5, -3.25,  39.8, 25.5, 1.25],
            rotations=[0, 1.57],
...
test_cfg = dict(
    ...
    post_center_limit_range = [0, -25.5, -3.25,  39.8, 25.5, 1.25],
    max_per_img=100,
)

# dataset settings
dataset_type = "KittiDataset"
data_root = "/home/ben/Dataset/KITTI"

db_sampler = dict(
    type="GT-AUG",
    enable=True,
    db_info_path="/home/ben/Dataset/KITTI/dbinfos_train.pkl",
...
voxel_generator = dict(
    ...
    range = [0, -25.5, -3.25,  39.8, 25.5, 1.25],
...
train_anno = "/home/ben/Dataset/KITTI/kitti_infos_train.pkl"
val_anno = "/home/ben/Dataset/KITTI/kitti_infos_val.pkl"
test_anno = None
...
log_level = "INFO"
work_dir = "/home/ben/projects/Det3D/training_results"
load_from = None
resume_from = None
