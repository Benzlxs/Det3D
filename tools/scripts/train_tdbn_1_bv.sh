...
python ./tools/train.py examples/second/configs/tdbn1_det2_bv.py --work_dir=$SECOND_WORK_DIR
#pudb3 ./tools/train.py examples/second/configs/tdbn1_det2_bv.py --work_dir=$SECOND_WORK_DIR
